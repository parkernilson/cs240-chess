...
public class EscapeSequences {
    ...
    public static final String BLACK = SET_TEXT_COLOR_BLACK;
    public static final String LIGHT_GREY = SET_TEXT_COLOR_LIGHT_GREY;
    public static final String DARK_GREY = SET_TEXT_COLOR_DARK_GREY;
    public static final String RED = SET_TEXT_COLOR_RED;
    public static final String GREEN = SET_TEXT_COLOR_GREEN;
    public static final String YELLOW = SET_TEXT_COLOR_YELLOW;
    public static final String BLUE = SET_TEXT_COLOR_BLUE;
    public static final String MAGENTA = SET_TEXT_COLOR_MAGENTA;
    public static final String WHITE = SET_TEXT_COLOR_WHITE;

    public static final String RESET_TEXT_COLOR = SET_TEXT_COLOR + "0m";
    public static final String RESET = RESET_TEXT_COLOR;
    ...
    public static final String BG_BLACK = SET_BG_COLOR_BLACK;
    public static final String BG_LIGHT_GREY = SET_BG_COLOR_LIGHT_GREY;
    public static final String BG_DARK_GREY = SET_BG_COLOR_DARK_GREY;
    public static final String BG_RED = SET_BG_COLOR_RED;
    public static final String BG_GREEN = SET_BG_COLOR_GREEN;
    public static final String BG_DARK_GREEN = SET_BG_COLOR_DARK_GREEN;
    public static final String BG_YELLOW = SET_BG_COLOR_YELLOW;
    public static final String BG_BLUE = SET_BG_COLOR_BLUE;
    public static final String BG_MAGENTA = SET_BG_COLOR_MAGENTA;
    public static final String BG_WHITE = SET_BG_COLOR_WHITE;
